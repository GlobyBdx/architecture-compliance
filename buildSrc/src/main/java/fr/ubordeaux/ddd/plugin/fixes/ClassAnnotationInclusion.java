...
import fr.ubordeaux.ddd.plugin.fixes.utils.ClassAnnotationInclusionProcessor;
...
public final class ClassAnnotationInclusion extends AbstractAnnotationInclusion {
    public ClassAnnotationInclusion(String annotation) {
        super(annotation);
    }
    ...
    public void use(String name, Description description, Project project) {
        if (description == null) {
            ProcessorLauncher.launch(
                    ...
                    new ClassAnnotationInclusionProcessor(
                            QuickFixUtils.getQualifiedClassName(name, project), this.getAnnotation(), project));
        }
        else {
            AnnotationManager.manage(description, name, this.getAnnotation(), true);
            description.update();
        }
    }
}
