...
public class MethodAnnotationInclusionProcessor extends AbstractProcessor<CtMethod<?>> {
    private final String name;
    private final String annotation;
    private final Project project;

    public MethodAnnotationInclusionProcessor(String name, String annotation, Project project) {
        this.name = name;
