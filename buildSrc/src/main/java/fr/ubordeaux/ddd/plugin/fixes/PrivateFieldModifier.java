...
import fr.ubordeaux.ddd.plugin.fixes.utils.PrivateFieldModifierProcessor;
...
public final class PrivateFieldModifier extends AbstractQuickFix {
    @Override
    public String getDescription() {
        return "Switches field's modifier to 'private'.";
    }
    ...
    public void use(String name, Description description, Project project) {
        ProcessorLauncher.launch(
                ...
                new PrivateFieldModifierProcessor(QuickFixUtils.getClassMemberName(name)));
    }
}
