...
public abstract class AbstractAnnotationInclusion extends AbstractQuickFix {
    private final String annotation;

    public AbstractAnnotationInclusion(String annotation) {
    ...
    public String getDescription() {
        return "Includes '" + annotation + "' annotation.";
    }
