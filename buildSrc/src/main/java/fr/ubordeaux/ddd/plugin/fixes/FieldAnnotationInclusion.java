...
import fr.ubordeaux.ddd.plugin.fixes.utils.FieldAnnotationInclusionProcessor;
...
public final class FieldAnnotationInclusion extends AbstractAnnotationInclusion {
    public FieldAnnotationInclusion(String annotation) {
        super(annotation);
    }
    ...
    public void use(String name, Description description, Project project) {
        if (description == null) {
            ProcessorLauncher.launch(
                    ...
                    new FieldAnnotationInclusionProcessor(
