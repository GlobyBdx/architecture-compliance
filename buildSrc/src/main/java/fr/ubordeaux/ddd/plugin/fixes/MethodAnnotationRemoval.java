...
import fr.ubordeaux.ddd.plugin.fixes.utils.MethodAnnotationRemovalProcessor;
...
public final class MethodAnnotationRemoval extends AbstractAnnotationRemoval {
    public MethodAnnotationRemoval(String annotation) {
        super(annotation);
    }
    ...
    public void use(String name, Description description, Project project) {
        if (description == null) {
            ProcessorLauncher.launch(
                    ...
                    new MethodAnnotationRemovalProcessor(
