...
public class FieldAnnotationInclusionProcessor extends AbstractProcessor<CtField<?>> {
    private final String name;
    private final String annotation;
    private final Project project;

    public FieldAnnotationInclusionProcessor(String name, String annotation, Project project) {
        this.name = name;
