...
public class PackageAnnotationInclusionProcessor extends AbstractProcessor<CtPackage> {
    private final String name;
    private final String annotation;
    private final Project project;

    public PackageAnnotationInclusionProcessor(String name, String annotation, Project project) {
        this.name = name;
