...
import fr.ubordeaux.ddd.plugin.fixes.utils.ClassAnnotationRemovalProcessor;
...
public final class ClassAnnotationRemoval extends AbstractAnnotationRemoval {
    public ClassAnnotationRemoval(String annotation) {
        super(annotation);
    }
    ...
    public void use(String name, Description description, Project project) {
        if (description == null) {
            ProcessorLauncher.launch(
                    ...
                    new ClassAnnotationRemovalProcessor(
