...
public class ClassAnnotationRemovalProcessor extends AbstractProcessor<CtClass<?>> {
    private final String name;
    private final String annotation;
    private final Project project;

    public ClassAnnotationRemovalProcessor(String name, String annotation, Project project) {
        this.name = name;
