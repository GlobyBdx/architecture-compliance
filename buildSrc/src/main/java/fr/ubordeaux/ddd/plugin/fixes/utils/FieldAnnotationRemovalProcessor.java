...
public class FieldAnnotationRemovalProcessor extends AbstractProcessor<CtField<?>> {
    private final String name;
    private final String annotation;
    private final Project project;

    public FieldAnnotationRemovalProcessor(String name, String annotation, Project project) {
        this.name = name;
