...
import fr.ubordeaux.ddd.plugin.fixes.utils.PrivateMethodModifierProcessor;
...
public final class PrivateMethodModifier extends AbstractQuickFix {
    @Override
    public String getDescription() {
        return "Switches method's modifier to 'private'.";
    }
    ...
    public void use(String name, Description description, Project project) {
        ProcessorLauncher.launch(
                ...
                new PrivateMethodModifierProcessor(QuickFixUtils.getClassMemberName(name)));
    }
}
