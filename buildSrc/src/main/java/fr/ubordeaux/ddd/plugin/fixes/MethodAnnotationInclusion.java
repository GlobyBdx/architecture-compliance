...
import fr.ubordeaux.ddd.plugin.fixes.utils.MethodAnnotationInclusionProcessor;
...
public final class MethodAnnotationInclusion extends AbstractAnnotationInclusion {
    public MethodAnnotationInclusion(String annotation) {
        super(annotation);
    }
    ...
    public void use(String name, Description description, Project project) {
        if (description == null) {
            ProcessorLauncher.launch(
                    ...
                    new MethodAnnotationInclusionProcessor(
